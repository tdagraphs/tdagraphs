...
# Path
setwd("/.../COMPETITORS/Zhao/Ethereum")
...
lisSelTokens <- c(7, 26, 28, 31, 6, 4)

# **** To choose a type of graph ****
pathEdgeListFile = 'ETH100_EdgeList_A/A' # Graph based on Adjacency (only 0 and 1)
#pathEdgeListFile = 'ETH100_EdgeList_W/W' # Graph based on Weighted Adjacency (values between 0 and 1)
#pathEdgeListFile = 'ETH100_AGD_EdgeList_A/AGDA' # Graph based on the Average Geodesic Distance - Graph based on Adjacency
#pathEdgeListFile = 'ETH100_AGD_EdgeList_W/AGDW' # Graph based on the Average Geodesic Distance - Graph based on Weight

maxNetworks <- 31; # Number of Tokens
nameFolderINDEX = 'ETH100_INDEX/INDEXnetwork' 
