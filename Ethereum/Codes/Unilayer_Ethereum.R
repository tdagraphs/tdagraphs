...
setwd("/...PATH_ETHEREUM.../") #=== Working Directory ===#
...
#=== Unweighted ===#
#pathPDs = 'FILES/ETH100_AGD_A_PD/AGDA'; # AGD on Adjacency (PD)
#nameFileIDX <- 'IDXTimeResul/ETH100_AGD_EdgeList_A_'

#=== Weighted ===#
pathPDs = 'FILES/ETH100_AGD_W_PD/AGDW' # Weighted-Adjacency (PD)
nameFileIDX <- 'IDXTimeResul/ETH100_AGD_EdgeList_W_'
...
dateLow <- as.Date("2017-12-06") 
dateUp <- as.Date("2018-05-06") 
...
###################################
  ...
  #=== The new ones ===#
  resOutlier = AnomalyDetectionVec(data.frame(WTDA), max_anoms=0.1, period=60, alpha=(0.05/6), direction='both', only_last=FALSE, plot=TRUE) 
